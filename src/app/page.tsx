...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-slate-900 leading-tight">Criterion 4</p>
              <p className="text-[10px] text-slate-500 leading-tight">Achievement Management System</p>
            </div>
          </div>
      ...
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/40 to-white py-20 sm:py-28">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_rgba(37,99,235,0.08),_transparent_70%)]" />
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 rounded-full px-4 py-1.5 text-xs font-medium text-blue-700 mb-6">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
            {[
              ...
              { role: "Admin", href: "/admin/dashboard", desc: "System-wide analytics, approvals, reporting, and user management", color: "purple" },
            ].map((r) => (
              <Link key={r.role} href={r.href} className="group block rounded-xl border border-slate-200 bg-slate-50 p-6 hover:shadow-md hover:border-blue-200 transition-all">
                ...
                <div className="mt-4 flex items-center text-xs font-medium text-blue-600 group-hover:gap-2 gap-1 transition-all">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="flex h-6 w-6 items-center justify-center rounded bg-blue-600">
              <span className="text-[9px] font-bold text-white">NBA</span>
            </div>
            <span className="text-xs text-slate-500">Criterion 4 Achievement Management System</span>
          </div>
